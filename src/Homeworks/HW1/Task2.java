...
//       JEP 355 (JDK Enhancement Proposal 355) описывает введение текстовых блоков в Java,
//       что значительно упрощает работу с многострочными строками.
//       Текстовые блоки позволяют удобно создавать многострочные строковые литералы,
//       используя синтаксис с тройными кавычками (""").
//       Тройные кавычки - можно просто ввести три двойные кавычки подряд.
